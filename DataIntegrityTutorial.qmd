...
The VC Data Model 2.0 [@VC-DM2.0] provides us with the following required and optional structure as shown below. Note that the *comments* `//` are not legal JSON syntax but are included here to explain the contents in a compact manner.
