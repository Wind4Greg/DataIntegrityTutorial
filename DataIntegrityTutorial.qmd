...
We can use "type specific" subcontexts to better reflect our intent and get something like:
...
And we can further nest our definitions to reflect out intent with something like:
