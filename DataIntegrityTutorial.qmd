...
```{#lst-KeyFormats .javascript lst-cap="Different formations and representations for private and public keys."}
{
...
For deployment, since we already have a website, we can use the `did:web` method. For that we need a basic DID document such as that shown in @lst-DIDdoc.
