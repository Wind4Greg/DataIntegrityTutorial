...
* `src/EdDSAKeyGen.js`: creates private/public key pair. Puts them into multiple convenient formats in `allKeys.json` file; create `did.json` file with public key for `did:web` method.
